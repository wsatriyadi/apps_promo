	...
	.run(function($ionicPlatform,$window,$interval,$timeout,$ionicHistory,$ionicPopup,$state,$rootScope){
		...
		$ionicPlatform.ready(function() {
			...
			if (typeof AdMob !== "undefined"){
				var admobid = {};
				admobid = {
					banner: "ca-app-pub-9424912518456288/6290202727",
					interstitial: "ca-app-pub-9424912518456288/5907059346",
					rewardvideo: "ca-app-pub-9424912518456288/1547058221"
				};
				$timeout(function(){
